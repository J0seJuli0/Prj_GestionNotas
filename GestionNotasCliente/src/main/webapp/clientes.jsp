...
<div class="container mt-4 p-4" style="border: 1px solid #ccc; border-radius: 20px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
    <div class="row">
        <div class="col-12">
            ...
            <form action="EstudianteController" method="get" class="d-flex justify-content-end m-1 gap-2">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                <%
                    List<Estudiantes> clientes = (List<Estudiantes>) request.getAttribute("clientes");
                    if (clientes != null && !clientes.isEmpty()) {
                        for(Estudiantes cliente : clientes) {
                %>
                    <tr>
                        <td><%= cliente.getIdEstudiante() %></td>
                        ...
                        <td><%= cliente.getPadre() %></td>
                        <td class="text-center">
                            <a href="EstudianteController?accion=editar&id=<%= cliente.getIdEstudiante() %>" class="btn btn-sm btn-success btn-custom">Editar</a>
                            <a href="EstudianteController?accion=eliminar&id=<%= cliente.getIdEstudiante() %>" class="btn btn-sm btn-danger btn-custom eliminar-cliente">Eliminar</a>
                        </td>
                    </tr>
                <%
                        }
      ...
      <div class="modal-body">
        <form id="formularioRegistro" action="EstudianteRegistro" method="post">
            ...
            <div class="text-center">
                ...
                <a href="EstudianteController" class="btn btn-danger">Cancelar</a>
            </div>
        </form>
      </div>
    </div>
